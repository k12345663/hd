...
try:
    ...
    print("Warning: LightGBM not available, skipping LGBM model")
...
models.append(('ada', AdaBoostClassifier(n_estimators=300, random_state=0, algorithm='SAMME')))
...
if LIGHTGBM_AVAILABLE:
    models.append(('lgbm', LGBMClassifier(n_estimators=500, learning_rate=0.03, max_depth=-1, subsample=0.8, colsample_bytree=0.8, random_state=0, verbose=-1)))
